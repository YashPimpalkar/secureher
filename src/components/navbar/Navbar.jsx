 ...
 {/* logos and list form */}
      ...
      <div className="flex items-center justify-center gap-2 ">
          ...
          <div className='flex flex-col'>
            <strong className=' text-2xl '>Secure<span className='text-accent'> her</span></strong>
            <span className='text-xs ml-0.5 '>you can always feel safe</span>
          </div>
        </div>
        <ul className='flex flex-col gap-y-5'>
          <li>
            <a href="#" className='text-secondary hover:text-accent transition-all'>Home</a>
          </li>
          <li>
            <a href="#" className='text-secondary hover:text-accent transition-all'>Emergency Support</a>
          </li>
          <li>
            <a href="#" className='text-secondary hover:text-accent transition-all'>Events</a>
          </li>
          <li>
            <a href="#" className='text-secondary hover:text-accent transition-all'>Forum</a>
          </li>
          <li>
            <a href="#" className='text-secondary hover:text-accent transition-all'>SOS</a>
          </li>
        </ul>
        ...
        <form className='relative flex gap-x[10px]'>
          ...
          <input type="text" id='mnav-search-input' placeholder='Search...' className='outline-none w-[160px] border-b-2 focus:border-b-2 focus:border-accent placeholder:italic rounded-xl' />
        </form>
      </div>
    </nav>
  {/* desktop nav */}
    ...
    <ul className='flex  gap-x-4'>
          <li>
            <a href="#" className='border-r pr-4 text-secondary hover:text-accent transition-all'>Home</a>
          </li>
          <li>
            <a href="#" className='border-r pr-4 text-secondary hover:text-accent transition-all'>Emergency Support</a>
          </li>
          <li>
            <a href="#" className='border-r pr-4 text-secondary hover:text-accent transition-all'>Events</a>
          </li>
          <li>
            <a href="#" className='border-r pr-4 text-secondary hover:text-accent transition-all'>Forum</a>
          </li>
          <li>
            <a href="#" className=' text-secondary hover:text-accent transition-all'>SOS</a>
          </li>
